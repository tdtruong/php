...
<form id="formThemQC" method="POST" enctype="multipart/form-data">
	<table class="theloai" width="1000px" align="center" cellpadding="0" cellspacing="0" border="1">
        <tr>
            <td colspan="7" class="header">THÊM QUẢNG CÁO</td>
        </tr>
        <tr>
            <td class="title qc">Vị Trí</td>
            <td>
            	<input type="number" name="vitri"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td>
            	<input type="number" name="SoLanClick"/>
            </td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
            <td>
            	<button type="submit" name="btnThemQC">Thêm</button>
            </td>
        </tr>
    </table>
</form>
