...
<form id="formSuaTin" method="POST">
    <table class="theloai" width="1000px" align="center" cellpadding="0" cellspacing="0" border="1">
        ...
        <tr>
            ...
            <td>
            	<textarea name="TomTat" cols="10" rows="10"><?php echo $row_tin['TomTat'] ?></textarea>
            </td>
        </tr>
        <tr>
            <td class="title tin">Hình Ảnh</td>
            <td>
            	<input class="hinhanh" type="text" name="urlHinh" value="<?php echo $row_tin['urlHinh'] ?>"/>
        ...
        <tr>
            ...
            <td>
            	<textarea name="Content" cols="10" rows="10"><?php echo $row_tin['Content'] ?></textarea>
                <script type="text/javascript">
        ...
        <tr>
            ...
            <td>
            	<select name="idLT" id="idLT">
					...
					?>
                	<option <?php if($row_tin['idLT'] == $row_theloai['idLT']) {echo 'selected="selected"';} ?> value="<?php echo $row_loaitin['idLT'] ?>"><?php echo $row_loaitin['Ten'] ?></option>
                    <?php
						}
					?>
                </select>
        ...
        <tr>
            ...
            <td>
            	<p>
            	  <label>
            	    <input type="radio" name="TinNoiBat" value="1" id="noibat" <?php if($row_tin['TinNoiBat'] == 1) {echo 'checked="checked"';} ?>/>
            	    Nổi Bật</label>
            	  <br />
            	  <label>
            	    <input type="radio" name="TinNoiBat" value="0" id="binhthuong" <?php if($row_tin['TinNoiBat'] == 0) {echo 'checked="checked"';} ?> />
            	    Bình Thường</label>
            	  <br />
       	    	</p>
            </td>
        ...
        <tr>
            ...
            <td>
           	  	<p>
            	  <label>
            	    <input type="radio" name="AnHien" value="1" id="hien" <?php if($row_tin['AnHien'] == 1) {echo 'checked="checked"';} ?>/>
            	    Hiện</label>
            	  <br />
            	  <label>
            	    <input type="radio" name="AnHien" value="0" id="an" <?php if($row_tin['AnHien'] == 0) {echo 'checked="checked"';} ?>/>
            	    Ẩn</label>
            	  <br />
       	    	</p>
            </td>
        ...
        <tr>
        	<td>&nbsp;</td>
            <td>
            	<button type="submit" name="btnSuaTin">Sửa</button>
            </td>
        </tr>
    </table>
</form>
