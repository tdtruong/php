	...
	<div class="cat">
        ...
        <div class="cat-content">
        	<div class="col1">
            	<div class="news">
                    <?php
                        $tintrai = LayTinMoiNhatBenTrai($idTL);
            ...
            <div class="col2">
                <?php
                    $tinphai = LayTinMoiNhatBenPhai($idTL);
                    while ($row_tinphai = mysql_fetch_array($tinphai)) {
                ?>
                <p class="tlq">
                    <a href="index.php?p=chitiettin&idTin=<?php echo $row_tintrai['idTin']; ?>"><?php echo $row_tinphai['TieuDe'] ?></a></a>
                </p>
                <?php } ?>
            </div>    
        </div>
