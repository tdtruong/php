...
<div class="clear"></div>
	<ul>
      <?php
        $tincungloai = LayTinCungLoai($idTin, $row_tin['idLT']);
        while ($row_tincungloai = mysql_fetch_array($tincungloai)) {
      ?>
        <li>       
             <a href="chitiet/<?php echo $row_tincungloai['idTin'] ?>-<?php echo $row_tincungloai['TieuDe_KhongDau'] ?>.html"><img src="upload/tintuc/<?php echo $row_tincungloai['urlHinh'] ?>" alt="<?php echo $row_tincungloai['TieuDe'] ?>"></a> <br />
		          <a class="title" href="chitiet/<?php echo $row_tincungloai['idTin'] ?>-<?php echo $row_tincungloai['TieuDe_KhongDau'] ?>.html"><?php echo $row_tincungloai['TieuDe'] ?></a>
             <span class="no_wrap">   
        </li>
        <?php } ?>
    </ul>
